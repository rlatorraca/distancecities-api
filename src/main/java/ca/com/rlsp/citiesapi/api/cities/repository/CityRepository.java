package ca.com.rlsp.citiesapi.api.cities.repository;
...
public interface CityRepository extends JpaRepository<City, Long> {
        ...
        @Query(value = "SELECT ((SELECT lat_lon FROM tbl_city_br WHERE id=?1) <@> (SELECT lat_lon FROM tbl_city_br WHERE id=?2)) as distance", nativeQuery = true)
