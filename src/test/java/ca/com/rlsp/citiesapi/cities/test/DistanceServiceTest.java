package ca.com.rlsp.citiesapi.cities.test;
...
class DistanceServiceTest {
    ...
    public void shouldCalculateInMetersUsingMath() {
        ...
        Double distance = distanceService.distanceUsingMath(4929L, 5254L, EarthRadius.METERS);
    ...
    public void shouldCalculateInKilometersUsingMath() {
        ...
        Double distance = distanceService.distanceUsingMath(4929L, 5254L, EarthRadius.KILOMETERS);
    ...
    public void shouldCalculateInMilesUsingMath() {
        ...
        Double distance = distanceService.distanceUsingMath(4929L, 5254L, EarthRadius.MILES);
    ...
    public void shouldCalculateInMetersUsingPoints() {
        ...
        Double distance = distanceService.distanceUsingPoints(4929L, 5254L, EarthRadius.METERS);
